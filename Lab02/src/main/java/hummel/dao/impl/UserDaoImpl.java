...
public strictfp class UserDaoImpl implements UserDao {
	...
	@Override
	public strictfp double getBalance(int userId) throws ConnectionException, SQLException {
		double result = -1.0;
		Connection connection = POOL.getConnection();
		PreparedStatement statement = null;
		try {
